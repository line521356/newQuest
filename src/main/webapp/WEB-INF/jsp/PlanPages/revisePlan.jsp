...
<body>
	...
	layui.use(['form', 'layedit', 'laydate'], function(){			//必须监听表单，否则某些样式出不来
		  ...
		  form.on('submit(demo1)', function(data){
			    ...
			    //整合所有数据拼成Emergency对象
				var req = { "crew":crewIDs.join(","), "priority":cfrmEndRts.length, "planName":data.field.planName, "planIntro":data.field.planIntro}
